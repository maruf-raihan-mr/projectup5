...
<body>
    ...
    <div class="container">
        ...
        <button style="margin-left:50rem ;" class="btn btn-success" name="back" ><a style="text-decoration:none ; color:white;" href="./admin/admin_index.php">Back</a> </button>
